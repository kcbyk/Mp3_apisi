...
<b>saglayici:</b> <code>auto</code> (varsayılan, zincir) · <code>pollinations</code> (flux, en iyi estetik) · <code>ovh</code> (SDXL yedeği, yalnız 1024x1024) · <code>cloudflare</code> (edge GPU ~1.4sn, günlük 173 hak — CF token tanımlıysa) · <code>arena</code> (tarayıcı, eski).<br>
